...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bonus_cards', (
            ...
            ('created_at', self.gf('django.db.models.fields.DateField')(blank=True, auto_now_add=True)),
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='not activated', max_length=20)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('bonus_cards')


    models = {
        'bonus_cards.bonuscard': {
            'Meta': {'object_name': 'BonusCard', 'db_table': "'bonus_cards'"},
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'created_at': ('django.db.models.fields.DateField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'not activated'", 'max_length': '20'}),
